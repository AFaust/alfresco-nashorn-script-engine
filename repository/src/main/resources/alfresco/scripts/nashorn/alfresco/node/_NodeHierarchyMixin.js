 ...
 */
define(
        [ '_base/declare', '_base/ProxySupport', 'alfresco/common/QName', 'alfresco/foundation/NodeService', '_base/logger', 'nashorn!Java' ],
        function alfresco_node_NodeHierarchyMixin__root(declare, ProxySupport, QName, NodeService, logger, Java)
        {
            'use strict';
            ...
            return declare([ ProxySupport ], {
                 ...
                 * @instance
                 * @param {string}
                 *            [nodeModuleId] the name of the script module to use for representing the parent node (defaults to the type of
                 *            this node)
                ...
                getParent : function alfresco_node_NodeHierarchyMixin__getParent(nodeModuleId)
                {
                    ...
                    if (!this.hasOwnProperty('parent'))
                    {
                        ...
                        result = parentAssoc.parentRef ? convertNode(parentAssoc.parentRef, this.declaredClass) : null;
                 ...
                 * @instance
                 * @param {string}
                 *            [nodeModuleId] the name of the script module to use for representing the parent nodes (defaults to the type of
                 *            this node)
                 ...
                 * @instance
                 * @param {string}
                 *            [nodeModuleId] the name of the script module to use for representing the child nodes (defaults to the type of
                 *            this node)
                ...
                /**
                 * This function provides a specific hook for other modules to call to reset only cached data regarding node hierarchies
                 * when other operations may have changed the specific node state.
                 */
