...
define([ '_base/declare', '_base/ProxySupport', '../common/QName', '_base/ConversionService', '../foundation/DictionaryService',
        '../foundation/NodeService', '_base/logger', 'nashorn!Java' ], function alfresco_node_NodePropertiesMap_root(declare, ProxySupport,
        QName, ConversionService, DictionaryService, NodeService, logger, Java)
{
    'use strict';
    var NodeRef, List, IllegalArgumentException;
                    ...
                    switch (prop)
                    {
                        ...
                        default:
                            ...
                            else
                            {
                                ...
                                value = this.inherited(alfresco_node_NodePropertiesMap__get__, arguments) || null;
                            }
                    }
                }
            }
            ...
            if (typeof prop === 'string')
            {
                ...
                else
                {
                    switch (prop)
                    {
                        ...
                        default:
                            qname = QName.valueOf(prop);
                            result = this.effectiveScriptProperties.hasOwnProperty(qname) || this.nodeProperties.hasOwnProperty(qname);
                    }
                }
            }
