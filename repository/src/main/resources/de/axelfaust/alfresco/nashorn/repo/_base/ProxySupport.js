 ...
 */
/* globals -require */
define([ './declare', 'nashorn!JSAdapter', 'nashorn!Java', './logger' ], function ProxySupport__define(declare, JSAdapter, Java, logger)
{
    'use strict';
    ...
    return declare([], {
        ...
        /**
         * The configuration property to enable proxy support, causing this
         * instance to be exposed via a JSAdapter proxy
         * 
         * @instance
         * @protected
         * @type {boolean}
        ...
        /**
         * The stack of property names which are currently being processed in
         * the [__noSuchProperty__]{@link module:_base/ProxySupport~__noSuchProperty__}
         * function. This serves to guard against infinite recursions in case
         * the logic (a getter) to retrieve a field attempts to access that
         * field itself.
         * 
         * @instance
         * @protected
        ...
        /**
         * The configuration property to enable fallback of [__noSuchProperty__]{@link module:_base/ProxySupport~__noSuchProperty__}
         * to [__get__]{@link module:_base/ProxySupport~__get__}
         * 
         * @instance
         * @protected
         * @type {boolean}
        ...
        /**
         * The configuration property to enable redirection of direct property
         * access to implemented getters via the [__get__]{@link module:_base/ProxySupport~__get__}
         * proxy operation.
         * 
         * @instance
         * @protected
        ...
        /**
         * The configuration property to enable simulation of getters for
         * properties via the [__call__]{@link module:_base/ProxySupport~__call__}
         * proxy operation.
         * 
         * @instance
         * @protected
        ...
        /**
         * The configuration property to enable fallback of [__call__]{@link module:_base/ProxySupport~__call__}
         * to [__get__]{@link module:_base/ProxySupport~__get__} when trying to
         * simulate a getter.
         * 
         * @instance
         * @protected
        ...
        /**
         * The configuration property to force use of getters for any property
         * access via the [__get__]{@link module:_base/ProxySupport~__get__}
         * proxy operation or [__noSuchProperty__]{@link module:_base/ProxySupport~__noSuchProperty__}
         * handler.
         * 
         * @instance
         * @protected
        ...
        /**
         * The configuration property to enable redirection of direct property
         * modification to implemented setters via the [__put__]{@link module:_base/ProxySupport~__put__}
         * proxy operation.
         * 
         * @instance
         * @protected
        ...
        /**
         * The configuration property to enable simulation of setters for
         * properties via the [__call__]{@link module:_base/ProxySupport~__call__}
         * proxy operation.
         * 
         * @instance
        ...
        /**
         * The configuration property to enable fallback of [__call__]{@link module:_base/ProxySupport~__call__}
         * to [__put__]{@link module:_base/ProxySupport~__put__} when trying to
         * simulate a setter.
         * 
         * @instance
         * @protected
        ...
        /**
         * The configuration property to force use of setters for any property
         * modification via the [__put__]{@link module:_base/ProxySupport~__put__}
         * proxy operation.
         * 
         * @instance
         * @protected
        ...
        classConstructor : function ProxySupport__classConstructor()
        {
            ...
            {
                specificAdaptee = Object.create(null, {
                    // early bind the common
                    // callbacks
                    __get__ : {
                        value : Function.prototype.bind.call(this.__get__, this)
                    },
                    __put__ : {
                        value : Function.prototype.bind.call(this.__put__, this)
                    },
                    __has__ : {
                        value : Function.prototype.bind.call(this.__has__, this)
                    },
                    __delete__ : {
                        value : Function.prototype.bind.call(this.__delete__, this)
                    },
                    __call__ : {
                        value : Function.prototype.bind.call(this.__call__, this)
                    },
                    // lazily handle the
                    ...
                    __getIds__ : {
                        ...
                        {
                            return Function.prototype.bind.call(_this.__getIds__, _this);
                        }
                    },
                    __getValues__ : {
                        get : function ProxySupport__constructor_lazyGetValuesBind()
                        {
                            return Function.prototype.bind.call(_this.__getValues__, _this);
                        }
                    },
                    __new__ : {
                        get : function ProxySupport__constructor_lazyNewBind()
                        {
                            return Function.prototype.bind.call(_this.__new__, _this);
                        }
                    }
                });
        ...
        __get__ : function ProxySupport__get__(name, __noSuchProperty__call)
        {
            ...
            {
                logger.trace('Returning defined function {} from __get__', name);
                result = this[name];
            }
            else if (this['--proxy-use-getter-only'] !== true && __noSuchProperty__call !== true)
            {
                // either exists or handled by __noSuchProperty__
                logger.trace('Accessing instance property {} in __get__', name);
                result = this[name];
            }
            else if (this['--proxy-getter-redirection-enabled'] === true)
            {
                logger.trace('Trying to redirect property {} to getters in __get__', name);
            ...
            if (typeof result === 'function')
            {
                ...
                logger.trace('Binding function retrieved from property {} in __get__ to proper scope', name);
                _this = this;
        ...
        /**
         * Retrieves the ids of all (public) properties of this instance. This
         * property handler will consider any property that can be determined to
         * exist on this instance via the "in" operator (unless only getters are
         * set to be allowed) and any property that can either be simulated via
         * getters or have actual getters implemented (if getter redirection is
         * enabled).
         * 
         * @instance
         * @protected
        ...
        /**
         * Retrieves the values of all (public) properties of this instance.
         * This property handler will consider any property that can be
         * determined to exist on this instance via the "in" operator (unless
         * only getters are set to be allowed) and any property that can either
         * be simulated via getters or have actual getters implemented (if
         * getter redirection is enabled).
         * 
         * @instance
         * @protected
        ...
        /**
         * Deletes a property on this instance. This property handler will
         * delete any property that can be determined to exist on this instance
         * via the "in" operator.
         * 
         * @instance
         * @protected
        ...
        /**
         * Calls a function on this instance. This proxy handler will simulate
         * getters / setters if the corresponding configuration properties have
         * been set to enable those features and an implemented method with the
        ...
        /**
         * Creates a new object instance from this constructor instance (if this
