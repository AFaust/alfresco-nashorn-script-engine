...
define('legacyRootObjects', [ 'globalProperties!nashornJavaScriptProcessor.de.axelfaust.alfresco.nashorn.repo.legacyRootObjects.*' ],
        function legacyRootObjects_loader(legacyRootObjects)
        {
            'use strict';
            ...
            /**
             * This loader module provides the capability to load legacy root objects as AMD modules. The set of available legacy root
             * objects is constructed from AMD modules registered with this loader via
             * nashornJavaScriptProcessor.de.axelfaust.alfresco.nashorn.repo.legacyRootObjects.* configuration in the
             * alfresco-global.properties file(s) and the script argument model.
             * 
