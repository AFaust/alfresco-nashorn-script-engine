...
(function()
{
    ...
    define(
            ...
            {
                var anonClassCount = 0, DummyCtor, FnCtor, isObject, fn_toString, isInstanceOf, inherited, forceNew, applyNew, standardConstructor, taggedMixin, standardPrototype, declareImpl, declareFn;
