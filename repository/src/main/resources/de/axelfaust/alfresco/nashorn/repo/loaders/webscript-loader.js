define('webscript', [ 'define', 'spring!webscripts.searchpath', 'spring!contentService', 'spring!retryingTransactionHelper' ], function(define, searchPath, contentService, retryingTransactionHelper)
{
    ...
    return {
        load : function(normalizedId, require, load)
        {
            ...
            if (script !== null)
            {
                url = new java.net.URL('webscript', null, -1, normalizedId,
                        new Packages.de.axelfaust.alfresco.nashorn.repo.loaders.WebScriptURLStreamHandler(script, contentService, retryingTransactionHelper));
