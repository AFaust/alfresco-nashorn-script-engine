...
public class ScriptSuite extends Suite
{
    ...
    {
        final Collection<String> scriptFiles = new LinkedHashSet<>();
        ...
        if (suiteFolders != null)
        {
            try
            {
                ...
                {
                    final URL rootResource = ScriptSuite.class.getClassLoader().getResource(".rootMarker");
    ...
    protected static List<Runner> buildRunners(final String[] scriptFiles) throws InitializationError
    {
        ...
        {
            runners.add(new ScriptFileRunner(scriptFile));
        }
        return runners;
    }
